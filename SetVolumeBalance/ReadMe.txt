========================================================================
    KONSOLENANWENDUNG: SetVolumeBalance-Projektübersicht
========================================================================

Diese SetVolumeBalance-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre SetVolumeBalance-Anwendung besteht.


SetVolumeBalance.vcxproj
...
SetVolumeBalance.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "SetVolumeBalance.pch und eine 
